...
library(tidyverse)
RAI_f <- read.csv("RAI_f.csv", header = T)
...
wildlife_data <- read.csv("mamiferos.csv", header = T)
...
RAIgral <- read.csv("Table_1.csv", header = T)
...
knitr::include_graphics("Dist_Abun.jpg")
```
...
knitr::include_graphics("Dist_Spp.jpg")
```
...
RAIalt <- read.csv("Table_2.csv", header = T)
...
knitr::include_graphics("RAIalt.jpg")
```
...
x1 <- read.csv("Table_Spp_Events.csv", header = T)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
x2 <- read.csv("Table_Spp_IAR.csv", header = T)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results= "asis"}
Tab_aov <- read.csv("Table_ANOVA.csv", header = T)
...
knitr::include_graphics("HSD_test.jpg")
```
...
knitr::include_graphics("Tukey_test.jpg")
```
...
Tab_glm <- read.csv("Table_GLM.csv", header = T)
...
RAI <- read.csv("Table_3.csv", header = T)
...
knitr::include_graphics("Map_Syl_flo.jpg")
```
...
knitr::include_graphics("Kernel_Syl_flo.jpg")
```
...
knitr::include_graphics("KernelRaster_Syl_flo.jpg")
```
...
knitr::include_graphics("CT_grid.jpg")
```


```{r tabgrid, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
utm <- read.csv("UTMs_grid.csv", header = T)
...
knitr::include_graphics(c("Rplot1.jpeg", "Rplot2.jpeg", "Rplot3.jpeg"))
```
